...
// ============================================
    ...
    function initCursor() {
        ...
        function renderCursor() {
            // Suavizado para el anillo (lerp)
            ringX += (mouseX - ringX) * 0.15;
            ringY += (mouseY - ringY) * 0.15;
            // El punto sigue con un lerp rápido (casi instantáneo)
        ...
        // Estados hover usando EVENT DELEGATION (funciona en SPA Vue tras renderizar páginas nuevas)
    ...
    function initParallax() {
        ...
        if (contenido.dataset.parallaxInit) return;
        contenido.dataset.parallaxInit = '1';

        function update() {
            if (!document.contains(contenido)) return;
            var y = getScrollTop();
    ...
    function initScrollIndicator() {
        ...
        if (hero.dataset.scrollIndInit) return;
        hero.dataset.scrollIndInit = '1';
        ...
        function update() {
            if (!document.contains(ind)) return;
